...
document.getElementByClassName("+settings.Blurb+").addEventListener("click",AddtoCart());  
 }
else
document.getElementById("+settings.HexColor+").addEventListener("click",AddtoCart());
};
